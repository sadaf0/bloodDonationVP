...
ALTER TABLE recordadd ADD BagName varchar(50) Null;
DELETE FROM bloodbagentry WHERE id = 'BE-102';



Create table newhsptlentry(hname  varchar(50) Null, Addres varchar(50) Null,cn varchar(50)Null,cdn varchar(50) Null);


Create table newtransaction(hname  varchar(50) Null, Addres varchar(50) Null,cn varchar(50)Null,cdn varchar(50) Null,Bloodgroup varchar(50)Null, DonorName varchar(50) Null,BagName varchar(50)Null,Transactiondate varchar(50)Null);
